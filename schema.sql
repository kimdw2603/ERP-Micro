...
-- -----------------------------------------------------
-- Table `ERP-Micro`.`employees`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ERP-Micro`.`employees` ;

CREATE TABLE IF NOT EXISTS `ERP-Micro`.`employees` (
...
CREATE TABLE IF NOT EXISTS `ERP-Micro`.`attendance` (
  ...
  CONSTRAINT `attendance_ibfk_1`
    ...
    REFERENCES `ERP-Micro`.`employees` (`employee_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- -----------------------------------------------------
-- Table `ERP-Micro`.`employees_detail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ERP-Micro`.`employees_detail` ;

CREATE TABLE IF NOT EXISTS `ERP-Micro`.`employees_detail` (
  `employee_ID` VARCHAR(7) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ERP-Micro`.`payment_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ERP-Micro`.`payment_category` ;

CREATE TABLE IF NOT EXISTS `ERP-Micro`.`payment_category` (
